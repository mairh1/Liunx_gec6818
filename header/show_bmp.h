...
/*
	...
	返回值：成功  0
			失败  -1
*/
extern int show_1152000bmp(char *pathname, int *show_1152000bmp_fd);
...
/*
	...
	返回值：成功  0
			失败  -1	
*/
extern int pic_circular_spread(char *pathname, int* pic_circular_spread_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int pic_circular_shrink(char *pathname, int* pic_circular_shrink_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int pic_down(char *pathname, int* pic_down_fd);
...
/*
	...
	返回值：成功  0
			失败  -1
*/
extern int pic_up(char *pathname, int* pic_up_fd);
...
/*
	...
	返回值：成功  0
			失败  -1	
*/
extern int pic_left(char *pathname, int* pic_left_fd);
...
/*
	...
	返回值：成功  0
			失败  -1	
*/
extern int pic_right(char *pathname, int* pic_right_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int pic_transverse_blinds(char *pathname, int* pic_transverse_blinds_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int pic_vertical_blinds(char *pathname, int* pic_vertical_blinds_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int pic_left_right_coincidence(char *pathname, int* pic_left_right_coincidence_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int pic_mid_spread(char *pathname, int *pic_mid_spread_fd);
...
/*
	...
	返回值：成功  0
			失败  -1	
*/
extern int pic_oblique_block(char *pathname, int *pic_oblique_block_fd);
...
/*
	...
	返回值：成功  0
			失败  -1		
*/
extern int clear_lcd_screen(int color, int lcd_x_coordinates, int lcd_y_coordinates, int wide, int height,int *lcd_mmap);
